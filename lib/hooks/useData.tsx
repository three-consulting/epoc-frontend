...
function useDataInternalState<T>(request: Promise<ResponseWithStatus<T>>): UseDataType<T> {
...
function useData<T>(callback: () => Promise<ResponseWithStatus<T>>): [UseDataType<T>, () => void] {
